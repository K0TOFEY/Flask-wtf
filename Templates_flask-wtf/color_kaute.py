...
def login():
    if request.method == 'GET':
        return render_template('double_protect.html')
    elif request.method == 'POST':
        # Получаем данные из формы
        print(request.form.get('id_astro'))
        print(request.form.get('password_astro'))
        print(request.form.get('id_cap'))
        print(request.form.get('password_cap'))
        return 'ok'
